        ...
        <div className="card hover:shadow-md transition-shadow duration-200">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-neutral-600 text-sm mb-4">Simple techniques to help you relax and reduce anxiety</p>
        ...
        <div className="card hover:shadow-md transition-shadow duration-200">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-neutral-600 text-sm mb-4">Practice mindfulness to stay present and centered</p>
              <ul className="space-y-1">
                <li className="text-sm text-neutral-700 flex items-center">
                  <span className="w-1.5 h-1.5 bg-primary-400 rounded-full mr-2"></span>
                  5-minute meditation
        ...
        <div className="card hover:shadow-md transition-shadow duration-200">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-neutral-600 text-sm mb-4">Healthy ways to manage difficult emotions</p>
              <ul className="space-y-1">
                <li className="text-sm text-neutral-700 flex items-center">
                  <span className="w-1.5 h-1.5 bg-primary-400 rounded-full mr-2"></span>
                  Journaling prompts
        ...
        <div className="card hover:shadow-md transition-shadow duration-200">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-neutral-600 text-sm mb-4">Take care of your physical and mental well-being</p>
              <ul className="space-y-1">
                <li className="text-sm text-neutral-700 flex items-center">
                  <span className="w-1.5 h-1.5 bg-primary-400 rounded-full mr-2"></span>
                  Exercise routine
